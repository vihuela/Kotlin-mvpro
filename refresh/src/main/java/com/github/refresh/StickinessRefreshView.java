...
public class StickinessRefreshView extends View {
    private StickinessRefreshViewHolder mStickinessRefreshViewHolder;
    ...
    private void initSize() {
        mEdge = RefreshLayout.dp2px(getContext(), 5);
        mRotateDrawableSize = RefreshLayout.dp2px(getContext(), 30);
...
//            mPath.quadTo(mTopBound.left + mTopSize / 8, mTopBound.bottom, mTopBound.left, mTopBound.bottom - mTopSize / 2);
    ...
    public void setStickinessRefreshViewHolder(StickinessRefreshViewHolder stickinessRefreshViewHolder) {
